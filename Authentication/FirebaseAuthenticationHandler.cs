...
namespace habitsbackend.Authentication;
 ...
 AuthenticationHandler<AuthenticationSchemeOptions>
{
    ...
    protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
    {
        ...
        try
        {
            ...
            {
                new ClaimsIdentity(ToClaims(firebaseToken.Claims), "placer")
    ...
    private IEnumerable<Claim> ToClaims(IReadOnlyDictionary<string, object> claims) => new List<Claim>
        {
